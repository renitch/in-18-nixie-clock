...
"C:\Program Files (x86)\IAR Systems\Embedded Workbench 5.4\common\bin\cspybat" "C:\Program Files (x86)\IAR Systems\Embedded Workbench 5.4\arm\bin\armproc.dll" "C:\Program Files (x86)\IAR Systems\Embedded Workbench 5.4\arm\bin\armjlink.dll"  %1 --plugin "C:\Program Files (x86)\IAR Systems\Embedded Workbench 5.4\arm\bin\<libsupport_plugin>" --macro "C:\Projects\in-18-nixie-clock\at91sam7s-ek\usb-device-cdc-serial-project\ewp\..\..\..\resources\iar\at91sam7s-ek-flash.mac" --flash_loader "C:\Program Files (x86)\IAR Systems\Embedded Workbench 5.4\arm\config\flashloader\Atmel\at91sam7s128-EK\at91sam7s128-flash.board" --backend -B "--endian=little" "--cpu=ARM7TDMI" "--fpu=None" "-p" "C:\Program Files (x86)\IAR Systems\Embedded Workbench 5.4\arm\CONFIG\debugger\Atmel\ioAT91SAM7S128.ddf" "--semihosting" "--device=AT91SAM7S128" "--drv_communication=USB0" "--jlink_speed=adaptive" 
